...
impl QuickXmlReadWrite for Field {
        ...
        for attr_res in attrs {
            ...
            field =
                match attr.key {
                    ...
                    b"precision" if !value.is_empty() => field
                        .set_precision(value.parse::<Precision>().map_err(VOTableError::ParseInt)?),
                    ...
                    b"arraysize" if !value.is_empty() => field
                        .set_arraysize(value.parse::<ArraySize>().map_err(VOTableError::ParseInt)?),
    ...
    fn read_sub_elements<R: BufRead>(
        ...
        self.read_sub_elements_by_ref(&mut reader, reader_buff, _context)
            .map(|()| reader)
    }
