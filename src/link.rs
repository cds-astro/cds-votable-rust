    ...
    fn from_attributes(attrs: Attributes) -> Result<Self, VOTableError> {
        ...
        for attr_res in attrs {
            ...
            link = match attr.key {
                ...
                b"content-role" => link
                    .set_content_role(ContentRole::from_str(value).map_err(VOTableError::Custom)?),
...
mod tests {
    ...
    fn test_link_read_write() {
        let xml = r#"<LINK ID="id" content-role="doc" content-type="text/text" href="http://127.0.0.1/"/>"#; // Test read
